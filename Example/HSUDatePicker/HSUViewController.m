...
- (void)selectDate
{
    HSUDatePicker *datePicker = [[HSUDatePicker alloc] initWithStartYear:2010 endYear:2015];
    ...
    datePicker.disabledColor = [UIColor lightGrayColor];
    datePicker.allowPastDateSelection = NO;
